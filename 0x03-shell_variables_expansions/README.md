# 0x03. Shell, init files, variables and expansions. This project introduces Expansions, Shell Arithmetic, Variables, Shell initialization files, The alias Command and Technical Writing
